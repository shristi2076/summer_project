...
if(isset($_POST['submit'])){
  ...
  $login_query = "SELECT * FROM admin WHERE user='$username' AND pass='$password'";
        ...
        <div class="col-lg-6 col-xs-12 col-md-6">
          ...
          <form id="login1" method="POST" action=""> 
            ...
            <label for="remember"> Remember me</label><br><br>    
             ...
             <button class="btn-order" name="submit" style="width:100%;"><a href="login_admin.php"></a> Login</button> <br><br>         
          </form>
          <a href="login_customer.php"><button class="btn-danger" style="margin-right: 15px;">Customer login</button></a>
          <a href="signup.php"><button class="btn-danger">Sign Up</button></a><br><br>   
        </div>           
      </div>
    </div>
  </section>
